            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="subject" id="" class="form-control" value="<?= isset($_GET['idEdit']) ? $row['subject'] : '' ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
                    <textarea name="subject" id="" class="form-control" value="<?= isset($_GET['idEdit']) ? $row['subject'] : '' ?>"></textarea>
                  </div>
                </div>
