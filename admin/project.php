...
$rows = mysqli_fetch_all($projects, MYSQLI_ASSOC);
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table table-responsive">
                                <a href="add-project.php" class="btn btn-primary mb-2">Create</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="add-project.php?idEdit=<?= $row['id'] ?>" class="btn btn-success btn-sm">Edit</a>
